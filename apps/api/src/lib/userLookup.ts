// User lookup via the mirrored user_profiles.email column so sharing checks
// and people rosters never scan auth.users. Pulled forward from upstream
// 82dcaef (backend/src/lib/userLookup.ts): upstream a5fe6d6 already imports
// this module but only ships it in the follow-up commit.
