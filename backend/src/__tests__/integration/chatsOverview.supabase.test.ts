...
//
// What this pins: 20260825_11 changed get_chats_overview's signature, and
...
maybeDescribe("get_chats_overview — deploy-window overload pair", () => {
    ...
    beforeAll(async () => {
        ...
        // 20260825_02; projects.shared_with is no longer the access source,
        ...
        // own org branch can never add a row" claim in 20260825_11's header
