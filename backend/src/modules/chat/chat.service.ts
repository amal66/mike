...
//
// IMPORTANT: the SSE streaming loop (header flush,
...
> {
    ...
    // apiKeys is fetched in the route via getUserApiKeys; here we only need
    // the legal_research_us flag for the stream.
