...
export class GCSStorageAdapter implements StorageAdapter {
    ...
    constructor() {
        ...
        this.enabled = Boolean(
            process.env.GCS_PROJECT_ID || process.env.GOOGLE_APPLICATION_CREDENTIALS,
        );
        this.bucket = process.env.GCS_BUCKET_NAME ?? "mike";
    }
    ...
    async getSignedUrl(
        key: string,
        expiresIn = Number(process.env.GCS_SIGNED_URL_TTL) || 3600,
