...
//
// The visibility predicates in 20260825_04 are the SQL twins of lib/access.ts,
...
const SOURCES = {
    "migrations/20260825_04_org_rpcs.sql": readFileSync(
        resolve(ROOT, "migrations/20260825_04_org_rpcs.sql"),
        "utf8",
    ),
