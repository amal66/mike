...
--
-- Now that chats carry shared_with + org_id (20260902_04), a chat has exactly
-- the shape 20260902_03's review_access_role() already takes: creator, own
...
--     chat: 20260902_04's backfill -- and resolveContentOrgId, which writes
...
--
--   The wrapper also drops the new is_owner and access_role columns, so an
--   old instance's `res.json(data)` returns the same six fields it always
--   did.
...
-- 20260902_04 without one, so give it the sibling index here.
--
