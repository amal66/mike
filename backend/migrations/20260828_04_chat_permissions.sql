...
-- (20260828_01): they gained the nullable `user_id` every project-tree table
...
--                 rather than deleting them, exactly as 20260828_01 does for
...
-- 20260828_02 moved projects off `shared_with` and onto role-carrying
...
-- in 20260828_05 safe — see that file's header.
--
