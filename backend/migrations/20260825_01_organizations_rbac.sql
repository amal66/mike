...
-- ---------------------------------------------------------------------------
-- Extends the signup trigger as last rebuilt by
-- 20260821_01_google_oauth_profiles (profile row + email mirror + the
-- OAuth full_name/name display-name fallbacks). Still swallows errors
-- (returns new) so a failed org insert never blocks signup — the backfill
-- migration is idempotent and will repair any user left without a personal
-- org.
