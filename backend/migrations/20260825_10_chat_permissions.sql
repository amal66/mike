...
-- (20260825_02): they gained the nullable `user_id` every project-tree table
...
--                 rather than deleting them, exactly as 20260825_02 does for
...
-- 20260825_03 moved projects off `shared_with` and onto role-carrying
...
-- in 20260825_11 safe — see that file's header.
--
