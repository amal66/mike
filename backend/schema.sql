...
-- (postgres 42725 / PostgREST PGRST203). See 20260902_05's header.
...
-- the old predicate exactly (see 20260902_05's header for the branch-by-branch
-- argument). Drop this together with 20260902_05's copy in a follow-up
